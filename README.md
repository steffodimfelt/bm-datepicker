...
```html
<bm-datepicker formControlNameInput="dateFrom" [styleSheet]="styles">
  <bm-datepicker></bm-datepicker
></bm-datepicker>
```
...
```html
<bm-datepicker pattern="dd-mm-yyyy" lockDateBefore="24-02-2023"></bm-datepicker>
<bm-datepicker pattern="dd-mm-yyyy" lockDateAfter="24-02-2023"></bm-datepicker>
```
